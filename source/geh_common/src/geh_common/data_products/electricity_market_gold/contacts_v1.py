...
schema = T.StructType(
    [
        ...
        T.StructField("relation_type", T.StringType(), not nullable),
        T.StructField("has_cpr", T.BooleanType(), not nullable),
        T.StructField("cvr", T.StringType(), nullable),
        T.StructField("is_protected_name", T.BooleanType(), not nullable),

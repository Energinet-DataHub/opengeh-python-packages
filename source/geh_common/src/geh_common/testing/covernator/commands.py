...
class OutputManager:
    ...
    Handles all console output, grouped logging, CSV, and stats.json writing.
    """
...
# =====================================================================
# === OutputManager: Unified Output and Logging =======================
# =====================================================================
...
class DuplicateKeyLoader(yaml.SafeLoader):
    def __init__(self, stream, group=None, scenario=None, output=None):
...
def find_all_cases(main_yaml_path: Path, output: OutputManager, group: str | None = None) -> List[CaseRow]:
...
def find_all_scenarios(base_path: Path, output: OutputManager) -> List[ScenarioRow]:
